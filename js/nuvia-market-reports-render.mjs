...
export function renderInforme(informe, { independiente = false } = {}) {
  ...
  return `<article class="nv-report nv-report--${informe.tipo.toLowerCase()}" aria-label="Informe ${etiqueta(informe.tipo).toLowerCase()}">
    ...
    ${mercados.length ? `<section class="nv-report__section nv-report__markets"><div class="nv-report__section-label"><h3>Los mercados de un vistazo</h3><span>${informe.tipo === 'SEMANAL' ? 'Cierre a cierre de los siete días' : 'Cierre de la última sesión'} · cada cifra, con su publicador</span></div>

...
export function promptRedaccion(tipo, hoy, investigacion) {
  const config = TIPOS[tipo];
...
Devuelve ÚNICAMENTE JSON válido, sin bloque de código alrededor, con esta forma exacta:
{
  ...
  "hechos": [{"texto": "hecho con su cifra y unidad", "fecha": "cuándo ocurrió"}],
  "indicadores": [{"etiqueta": "nombre", "valor": "valor con unidad", "referencia": "fecha y fuente"}],
  "agenda": [{"cuando": "fecha u hora", "que": "qué se publica o quién comparece"}],
  "cuerpo": [{"titulo": "título de sección", "parrafos": ["párrafo"]}],
